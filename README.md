...
sequenceDiagram
    ...
    R->>B: Submits Research/Experiment Logs On-Chain
    B-->>R: Mints On-Chain Profile & Assetizes Post
    P->>B: Interacts & Reviews Research (Expertise Graph)
    B->>B: Calculates Reliability Index & Reputation
    B-->>P: Rewards Reviewers with BioCoin Bounties
